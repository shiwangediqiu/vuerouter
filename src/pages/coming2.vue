<template>
    <div>
      ...
      <div>
        <ul class="ul">
        <li class="li"><v-link href="/coming1">第1页</v-link></li>
        <li class="li"><v-link href="/coming2">第2页</v-link></li>
      </ul>
      </div>      
...
<script>
  ...
  export default {
    ...
    mounted: function() {
        this.$http.jsonp('https://api.douban.com/v2/movie/coming_soon?start=50&count=50').then(response => {
